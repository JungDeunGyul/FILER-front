...
<div align="center">
  <img width="300" src="public/ReadMeGif3.gif">
</div>
...
<p align="center">
  <img width="300" src="public/ReadMeGif4.gif">
</p>
...
### adm-zip vs JSZip
---
React에서 파일 압축해제를 하기 위해 방법을 찾는 도중 adm-zip와 JSZip 라이브러리를 찾게 되었습니다.
...
---
  서버 측에서 파일 압축 해제를 선택한 이유는 사용자의 디바이스 성능에 의존하지 않고 안정적으로 대용량 파일을 처리할 수 있기 때문입니다. 클라이언트 측에서는 사용자의 디바이스 사양에 따라 파일 처리 작업에 실패할 수 있는 위험이 있습니다. 이에 반해 서버 측에서는 빠른 네트워크 연결과 하드웨어 리소스를 활용하여 대용량 파일을 효율적으로 처리할 수 있으며, 클라이언트의 디바이스 사양에 관계없이 일관된 성능과 안정성을 제공할 수 있습니다. 따라서 서버 측 파일 압축 해제를 선택하여 안정적이고 효율적인 파일 처리를 보장하기 위해 이 방법을 선택했습니다.
